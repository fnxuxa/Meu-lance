const messages: Record<string, string> = {
  ...
  AUCTION_ENDED: 'O prazo de lances deste anúncio já encerrou.',
  SELLER_CANNOT_BID: 'Você não pode dar lance no próprio anúncio.',
  ALREADY_LEADING: 'Você já lidera este anúncio. Pode aumentar seu teto automático.',
  ...
  DISPUTE_CLOSED: 'Esta disputa já foi encerrada.',
  MAX_EVIDENCE: 'Limite de 10 fotos por pessoa nesta disputa.',
  INVALID_EVIDENCE_PATH: 'Não foi possível anexar esta foto. Tente novamente.',
  ...
  IDENTITY_NOT_VERIFIED: 'Verifique sua identidade antes de publicar anúncios.',
  TOO_CLOSE_TO_END: 'Já tem lance e falta menos de 1 dia para o fim — não é mais possível cancelar.',
  HAS_BIDS: 'Este anúncio já recebeu lances e não pode mais ser cancelado dessa forma.',
  NOT_CANCELLABLE: 'Este anúncio não está mais em um estado que permite cancelamento.',
  ...
  NOT_RELISTABLE: 'Só é possível relançar anúncios encerrados sem lances.',
